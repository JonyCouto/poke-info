		...
		loading ?
			...
			<Grid2 container spacing={2} sx={{ justifyContent: "center", alignItems: "flex-start", height: "100%" }}>
				<Grid2 size={12} sx={{ display: "flex", justifyContent: "end" }}>
					<Pagination count={99} color="primary" page={page} onChange={changePagination} className="page" sx={{
						"& .MuiPaginationItem-root.Mui-selected": {
							backgroundColor: "#f05416"
						},
						"& .MuiPaginationItem-root:hover": {
							backgroundColor: "rgba(0, 0, 0, 0.3)", // Fundo no hover
						}
					}} />
				</Grid2>
				{
